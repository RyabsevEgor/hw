...
if int(pets[pet_name]['Возраст питомца'])%10 == 1:
  age_ending = 'год'
elif 1 < int(pets[pet_name]['Возраст питомца'])%10 < 5:
  age_ending = 'года'
elif 4 < int(pets[pet_name]['Возраст питомца'])%10 < 10:
  age_ending = 'лет'
...
+ '".','Возраст питомца:', pets[name]['Возраст питомца'], age_ending
